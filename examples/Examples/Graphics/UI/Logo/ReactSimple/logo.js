...
PS.Graphics_UI_Interpreter_ReactSimple = (function () {
    ...
    var React_Types = PS.React_Types;
    var positionComponent = new Graphics_UI.Position(function (x) {
        return function (y) {
            return function (comp) {
                return React.cloneWithProps(comp, {
                    style: {
                        display: "inline-block", 
                        position: "absolute", 
                        left: Prelude.show(Prelude.showNumber)(x) + "px", 
                        top: Prelude.show(Prelude.showNumber)(y) + "px"
                    }
                });
            };
        };
    });
    var imageComponent = new Graphics_UI.Image(function (url) {
...
PS.Data_Tuple = (function () {
    ...
    var uncurry = function (_243) {
        return function (_244) {
            return _243(_244.value0)(_244.value1);
        };
    };
    return {
        Tuple: Tuple, 
...
var PS = PS || {};
PS.Examples_Graphics_UI_Logo = (function () {
    "use strict";
    var Graphics_UI = PS.Graphics_UI;
    var Prelude = PS.Prelude;
    ...
    var Control_Monad_Eff = PS.Control_Monad_Eff;
    var DOM = PS.DOM;
    var Logo = function (__superclass_Graphics$dotUI$dotImage_0, __superclass_Graphics$dotUI$dotPosition_1) {
        this["__superclass_Graphics.UI.Image_0"] = __superclass_Graphics$dotUI$dotImage_0;
        this["__superclass_Graphics.UI.Position_1"] = __superclass_Graphics$dotUI$dotPosition_1;
    };
    var url = "https://raw.githubusercontent.com/goodworkson/purescript-logo/master/ps_avatar.png";
    var rawLogo = function (__dict_Logo_625) {
        return Graphics_UI.image(__dict_Logo_625["__superclass_Graphics.UI.Image_0"]())(url);
    };
    var moveLogo = function (__dict_Logo_626) {
        return function (x) {
            return function (y) {
                return Graphics_UI.position(__dict_Logo_626["__superclass_Graphics.UI.Position_1"]())(x)(y)(rawLogo(__dict_Logo_626));
            };
        };
    };
    var logo = function (__dict_Logo_627) {
        return function (renderer) {
            return function __do() {
                var _32 = FRP_Kefir.fromEvent(window)("mousemove")(function (ev) {
                    return new Data_Tuple.Tuple(ev.clientX, ev.clientY);
                })();
                return FRP_Kefir.onValue(_32)(Prelude[">>>"](Prelude.semigroupoidArr)(Data_Tuple.uncurry(moveLogo(__dict_Logo_627)))(renderer))();
            };
        };
    };
    return {
...
var PS = PS || {};
PS.Examples_Graphics_UI_Logo_ReactSimple = (function () {
    "use strict";
    var Examples_Graphics_UI_Logo = PS.Examples_Graphics_UI_Logo;
    var React = PS.React;
    var Prelude = PS.Prelude;
    var Graphics_UI_Interpreter_ReactSimple = PS.Graphics_UI_Interpreter_ReactSimple;
    var React_Types = PS.React_Types;
    var logoComponent = new Examples_Graphics_UI_Logo.Logo(function () {
        return Graphics_UI_Interpreter_ReactSimple.imageComponent;
    }, function () {
        return Graphics_UI_Interpreter_ReactSimple.positionComponent;
    });
    var main = Examples_Graphics_UI_Logo.logo(logoComponent)(function (comp) {
        return React.renderComponentById(comp)("content");
    });
    return {
        main: main, 
...
PS.Examples_Graphics_UI_Logo_ReactSimple.main();
